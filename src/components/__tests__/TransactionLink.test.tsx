...
import { FullTransactionLink, TransactionLink } from "../TransactionLink";
...
describe("TransactionLink", () => {
  ...
  describe("TransactionLink", () => {
    it("should render with default props", () => {
      ...
      expect(link).toHaveAttribute(
        "href",
        `https://sepolia.etherscan.io/tx/${mockHash}`,
      );
    ...
    it("should use custom network", () => {
      ...
      expect(link).toHaveAttribute(
        "href",
        `https://etherscan.io/tx/${mockHash}`,
      );
    });
  ...
  describe("FullTransactionLink", () => {
    ...
    it("should use correct network", () => {
      ...
      expect(link).toHaveAttribute(
        "href",
        `https://goerli.etherscan.io/tx/${mockHash}`,
      );
    });
  ...
  describe("different network support", () => {
    const networks = [
      { network: "mainnet" as const, expectedUrl: "https://etherscan.io" },
      {
        ...
        expectedUrl: "https://sepolia.etherscan.io",
      },
      {
        network: "goerli" as const,
        expectedUrl: "https://goerli.etherscan.io",
      },
    ];
